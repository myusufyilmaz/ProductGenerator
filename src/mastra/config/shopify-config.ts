  ...
  return {
    ...
    product_types: {
      "DTF": {
        ...
        vendor: "InkMerge",
        variants: [
          { size: "Adult Left Chest  (4\")", sku_suffix: "LC04IN", price: 1.99, inventory_quantity: 5000 },
          { size: "Adult Full Front (11\")", sku_suffix: "FF11IN", price: 4.99, inventory_quantity: 5000 },
          { size: "Youth (9\")", sku_suffix: "Y09IN", price: 3.99, inventory_quantity: 5000 },
          { size: "Toddler (6\")", sku_suffix: "T06IN", price: 2.99, inventory_quantity: 5000 },
          { size: "Hat (3\")", sku_suffix: "H03IN", price: 1.99, inventory_quantity: 5000 },
        ],
      },
      "POD": {
        ...
        vendor: "InkMerge",
        variants: [
          { size: "Small", sku_suffix: "S", price: 25.00, inventory_quantity: 5000 },
          { size: "Medium", sku_suffix: "M", price: 25.00, inventory_quantity: 5000 },
          { size: "Large", sku_suffix: "L", price: 25.00, inventory_quantity: 5000 },
        ],
      },
    },
    collections: [
